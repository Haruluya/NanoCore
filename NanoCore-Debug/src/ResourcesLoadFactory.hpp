...
namespace NanoCore {
	...
	public:
		...
		static void Init()
		{
			...
			MinimizeIcon = LoadTexture("Minimize.png", { "logoIcon", TextureWrap::Clamp });
			MaximizeIcon = LoadTexture("Maximize.png", { "logoIcon", TextureWrap::Clamp });
			RestoreIcon = LoadTexture("Restore.png", { "logoIcon", TextureWrap::Clamp });
			CloseIcon = LoadTexture("Close.png", { "logoIcon", TextureWrap::Clamp });
		}
