...
bool NanoCore::UI::BeginPopup(const char* str_id, ImGuiWindowFlags flags)
{
	bool opened = false;
...
void NanoCore::UI::RenderWindowOuterBorders(ImGuiWindow* window)
{
...
bool NanoCore::UI::UpdateWindowManualResize(ImGuiWindow* window, ImVec2& newSize, ImVec2& newPosition)
...
void NanoCore::UI::DrawShadow(const Shared<Texture2D>& shadowImage, int radius, ImVec2 rectMin, ImVec2 rectMax, float alphMultiplier, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
...
void NanoCore::UI::DrawShadow(const Shared<Texture2D>& shadowImage, int radius, ImRect rectangle, float alphMultiplier, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
{
...
void NanoCore::UI::DrawShadow(const Shared<Texture2D>& shadowImage, int radius, float alphMultiplier, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
{
...
void NanoCore::UI::DrawShadowInner(const Shared<Texture2D>& shadowImage, int radius, ImVec2 rectMin, ImVec2 rectMax, float alpha, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
...
void NanoCore::UI::DrawShadowInner(const Shared<Texture2D>& shadowImage, int radius, ImRect rectangle, float alpha, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
{
	DrawShadowInner(shadowImage, radius, rectangle.Min, rectangle.Max, alpha, lengthStretch, drawLeft, drawRight, drawTop, drawBottom);
}

void NanoCore::UI::DrawShadowInner(const Shared<Texture2D>& shadowImage, int radius, float alpha, float lengthStretch, bool drawLeft, bool drawRight, bool drawTop, bool drawBottom)
{
